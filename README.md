...
| **Valider les quêtes auto** (checkbox) | Si le leader valide (remet) une quête en cliquant « Terminer la quête », les membres qui ont le même panneau de remise ouvert **pour la même quête** valident automatiquement. Activé par défaut. |
